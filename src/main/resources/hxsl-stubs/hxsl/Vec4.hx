...
class Vec4 {
  ...
  private function get_xyzw():Vec4 return null;

  public var rgb(get, never):Vec3;
  private function get_rgb():Vec3 return null;

  public var rgba(get, never):Vec4;
  private function get_rgba():Vec4 return null;
  ...
  private function get_a():Float return 0;
}
